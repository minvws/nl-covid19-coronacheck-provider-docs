...
public class SignatureDemoTest {
    String keystore = "src/test/resources/keystore.p2";
    String password = "changeme";

    @Test
    public void signAndVerify() {
        String payload = "src/test/resources/payload.json";
        SignatureDemo.main(new String[] { "sign", keystore, password, payload});
    }

    @Test
    public void verify() {
        String payload = "src/test/resources/result.json";
        SignatureDemo.main(new String[] { "verify", keystore, password, payload});
    }
